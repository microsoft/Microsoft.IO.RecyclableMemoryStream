...
| name | description |
| --- | --- |
| [StreamDoubleDisposedEventArgs](RecyclableMemoryStreamManager.StreamDoubleDisposedEventArgs/StreamDoubleDisposedEventArgs.md)(…) | Initializes a StreamDoubleDisposedEventArgs struct |
